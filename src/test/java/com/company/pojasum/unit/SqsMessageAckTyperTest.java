package com.company.pojasum.unit;
...
import com.company.pojasum.conf.FacadeIT;
import com.company.pojasum.endpoint.event.EventConsumer;
import com.company.pojasum.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.company.pojasum.endpoint.event.gen.UuidCreated", payload);
