package com.company.pojasum.endpoint.event;
...
import com.company.pojasum.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "com.company.pojasum.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
